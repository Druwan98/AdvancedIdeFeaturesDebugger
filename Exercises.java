package Exercise.AdvancedIdeFeaturesDebugger;
...
public class Exercises {
    ...
    private static int calculateFactorial(int number) {
        //Fix this code
        int result = 1;
        for (int i = number; i >= 1; i --) {   //-=2  fix
            result = result * i;
        }
        String msg = "Bug Fixed.";
    ...
    private static String reverseString(String input) {
        ...
        for (int i = input.length() -1 ; i >= 0; i--) {
            reversed += input.charAt(i);  // -reversed fix
        }
        String msg = "Bug Fixed.";
        System.out.println(msg);
        return reversed;
    ...
    private static void exercise3() {
        ...
        Assertions.assertTrue(isPositive(0));  //assertFalse fix
